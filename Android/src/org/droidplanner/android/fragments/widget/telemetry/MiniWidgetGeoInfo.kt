...
class MiniWidgetGeoInfo : TowerWidget() {
    ...
    companion object {
        ...
        lateinit var instance: MiniWidgetGeoInfo
    ...
    private fun onPositionUpdate() {
        ...
        if (droneGps.isValid) {
            ...
            returnLat = droneGps.position.latitude
            returnLng = droneGps.position.longitude
            print("Borhan returnLat  " + returnLat + " actual value " + droneGps.position.latitude)
            print(" Borhan LAT:-")
            print(latitudeValue);
            print(" LONG:-")
